      ...
      <div class="header__menu">
        ...
        >
          ...
          <ul>
            ...
            <div class="header__contact-list-m">
              <li class="header__contact-item-m">
...
.header__contact-item-m:hover svg path {
  fill: #fff;
}

.header__contact-item:hover a,
.header__contact-item-m:hover a {
  background-color: #dd514c;
}

.header__contact-item a,
.header__contact-item-m a {
  width: 48px;
  height: 48px;
  background-color: #fff;
  border-radius: 50%;
...
.header__contact-item-m:last-child {
  margin-right: 0;
}
